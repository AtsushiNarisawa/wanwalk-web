        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <ul style={{ listStyle: "none", padding: 0 }}>
            ...
            <FeatureItem title="犬連れ実用情報 100%充填">
              全{routeCount}ルートでカート走行可否（cart_friendly）を判定し、
              主要カテゴリのスポット（カフェ・レストラン・ドッグラン・ショップ）は
              愛犬と入れるかどうかを一件ずつ確認したうえで掲載しています。
              受け入れできる犬のサイズや同伴できる場所などの条件は施設ごとに変わるため、
              サイトには掲載せず、各施設の公式サイトでご確認いただく方針です。
            </FeatureItem>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <ul style={{ listStyle: "none", padding: 0 }}>
            <FeatureItem title="犬連れに完全特化">
              全ルート・全スポットを、愛犬と歩けるか・立ち寄れるかという観点で確認し、
              カート走行可否まで判定して掲載。愛犬と安心してお出かけできる情報を提供します。
            </FeatureItem>
